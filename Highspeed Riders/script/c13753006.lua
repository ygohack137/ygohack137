...
function c13753006.initial_effect(c)
	...
	e3:SetCondition(c13753006.hspcon2)
	e3:SetOperation(c13753006.hspop)
	c:RegisterEffect(e3)
end
...
function c13753006.hspcon2(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetSummonType()==SUMMON_TYPE_SPECIAL+1
end
function c13753006.hspop(e,tp,eg,ep,ev,re,r,rp)
