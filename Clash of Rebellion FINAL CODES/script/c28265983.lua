...
function c28265983.initial_effect(c)
	...
	e2:SetCondition(c28265983.condition)
	e2:SetTarget(c28265983.target)
	e2:SetOperation(c28265983.activate)
	c:RegisterEffect(e2)
	--special summon
	...
	e3:SetCost(c28265983.cost)
	e3:SetCondition(c28265983.condition2)
	e3:SetOperation(c28265983.operation2)
	c:RegisterEffect(e3)
end
function c28265983.condition(e,tp,eg,ep,ev,re,r,rp)
	return ep==tp
end
...
function c28265983.activate(e,tp,eg,ep,ev,re,r,rp)
...
function c28265983.condition2(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetLP(1-tp)<Duel.GetLP(tp)
end
function c28265983.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	local dif=Duel.GetLP(tp)-Duel.GetLP(1-tp)
	Duel.PayLPCost(tp,dif)
	e:SetLabel(dif)
end
function c28265983.filter(c,atk)
	return c:IsFaceup() and c:IsAttackBelow(atk)
end
function c28265983.operation2(e,tp,eg,ep,ev,re,r,rp)
