...
function c24019092.initial_effect(c)
	...
	e2:SetCountLimit(1)
	e2:SetCondition(c24019092.sccon)
	e2:SetTarget(c24019092.sctg)
	e2:SetOperation(c24019092.scop)
	c:RegisterEffect(e2)
end
function c24019092.sccon(e,tp,eg,ep,ev,re,r,rp)
...
function c24019092.sctg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c24019092.scop(e,tp,eg,ep,ev,re,r,rp)
	...
	if g:GetCount()>0 then
		...
		if ct==2 then
			local fg=Duel.GetMatchingGroup(c24019092.filter,tp,LOCATION_DECK+LOCATION_GRAVE,0,nil)
