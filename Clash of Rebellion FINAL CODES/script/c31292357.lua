...
function c31292357.initial_effect(c)
	...
	e1:SetCondition(c31292357.condition)
	e1:SetOperation(c31292357.operation)
	c:RegisterEffect(e1)
	...
	e3:SetCondition(c31292357.valcon)
	e3:SetValue(3300)
	c:RegisterEffect(e3)
	local e4=e3:Clone()
...
function c31292357.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c31292357.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetLabel(cid)
	e1:SetValue(c31292357.refcon)
	e1:SetReset(RESET_CHAIN)
	Duel.RegisterEffect(e1,tp)
end
function c31292357.refcon(e,re,val,r,rp,rc)
