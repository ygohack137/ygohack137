...
function c5050644.initial_effect(c)
	...
	e1:SetCondition(c5050644.condition)
	e1:SetTarget(c5050644.target)
	e1:SetOperation(c5050644.operation)
	c:RegisterEffect(e1)
	--spsummon
	local e1=Effect.CreateEffect(c)
	...
	e1:SetCondition(c5050644.condition2)
	e1:SetTarget(c5050644.target2)
...
function c5050644.operation(e,tp,eg,ep,ev,re,r,rp)
...
function c5050644.target2(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetTargetPlayer(tp)
	Duel.SetTargetParam(1000)
	Duel.SetOperationInfo(0,CATEGORY_RECOVER,nil,0,tp,1000)
end
function c5050644.operation2(e,tp,eg,ep,ev,re,r,rp)
	if not e:GetHandler():IsRelateToEffect(e) then return end
	local p,d=Duel.GetChainInfo(0,CHAININFO_TARGET_PLAYER,CHAININFO_TARGET_PARAM)
