...
function c39357122.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(39357122,0))
...
function c39357122.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.IsExistingMatchingCard(c39357122.filter,tp,0,LOCATION_MZONE,1,nil,c:GetAttack()) end
end
function c39357122.desop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if not c:IsRelateToEffect(e) or c:IsFacedown() then return end
	local dg=Duel.GetMatchingGroup(c39357122.filter,tp,0,LOCATION_MZONE,nil,c:GetAttack())
