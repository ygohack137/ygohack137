...
function c50407691.initial_effect(c)
	...
	e2:SetCountLimit(1)
	e2:SetCondition(c50407691.sccon)
	e2:SetTarget(c50407691.sctg)
	e2:SetOperation(c50407691.scop)
	c:RegisterEffect(e2)
end
function c50407691.sccon(e,tp,eg,ep,ev,re,r,rp)
...
function c50407691.sctg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c50407691.scop(e,tp,eg,ep,ev,re,r,rp)
	...
	if g:GetCount()>0 then
		...
		if ct==2 then
			local fg=Duel.GetMatchingGroup(c50407691.filter,tp,LOCATION_DECK+LOCATION_GRAVE,0,nil)
