...
function c13790602.initial_effect(c)
	...
	e2:SetOperation(c13790602.operation)
	c:RegisterEffect(e2)
	--lv
	...
	e3:SetCountLimit(1)
	e3:SetTarget(c13790602.lvtg)
	e3:SetOperation(c13790602.lvop)
	c:RegisterEffect(e3)
end
...
function c13790602.lvop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local tc=Duel.SelectMatchingCard(tp,c13790602.filter,tp,LOCATION_HAND,0,1,1,nil)
	local hg=Duel.GetMatchingGroup(c13790602.afilter,tp,LOCATION_HAND,0,nil,tc:GetFirst():GetCode())
...
function c13790602.condition(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return c:IsReason(REASON_BATTLE)
end
function c13790602.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetOperationInfo(0,CATEGORY_DESTROY,e:GetHandler():GetBattleTarget(),1,0,0)
	Duel.SetOperationInfo(0,CATEGORY_DAMAGE,nil,0,1-tp,800)
end
function c13790602.operation(e,tp,eg,ep,ev,re,r,rp)
