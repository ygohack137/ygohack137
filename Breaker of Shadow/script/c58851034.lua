...
function c58851034.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c58851034.cfilter,tp,LOCATION_HAND,0,1,nil) 
	or e:GetHandler():IsHasEffect(13790664) end
	if e:GetHandler():IsHasEffect(13790664) then return true 
	else
