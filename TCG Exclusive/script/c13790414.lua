...
function c13790414.initial_effect(c)
	...
	e1:SetTarget(c13790414.target)
	e1:SetOperation(c13790414.operation)
	c:RegisterEffect(e1)
	...
	e3:SetCountLimit(1)
	e3:SetCondition(c13790414.scon)
	e3:SetTarget(c13790414.stg)
	e3:SetOperation(c13790414.sop)
	c:RegisterEffect(e3)
	--~ Xyz
	...
	e4:SetCountLimit(1)
	e4:SetCondition(c13790414.descon)
	e4:SetTarget(c13790414.destg)
	e4:SetOperation(c13790414.desop)
	c:RegisterEffect(e4)
end
