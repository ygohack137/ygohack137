...
function c98414735.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,98414735,0,0x11,4,1200,0,RACE_AQUA,ATTRIBUTE_WATER) end
...
function c98414735.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e)
		and Duel.IsPlayerCanSpecialSummonMonster(tp,98414735,0,0x11,4,1200,0,RACE_AQUA,ATTRIBUTE_WATER) then
