...
function c68625727.initial_effect(c)
	...
	e1:SetTarget(c68625727.target)
	e1:SetOperation(c68625727.operation)
	c:RegisterEffect(e1)
end
function c68625727.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c68625727.operation(e,tp,eg,ep,ev,re,r,rp)
