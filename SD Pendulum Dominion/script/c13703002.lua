...
function c13703002.initial_effect(c)
	...
	e2:SetCondition(c13703002.splimcon)
	e2:SetTarget(c13703002.splimit)
	c:RegisterEffect(e2)
	local e2=Effect.CreateEffect(c)
	...
	e2:SetRange(LOCATION_PZONE)
	e2:SetCountLimit(1)
	e2:SetCondition(c13703002.damcon1)
	e2:SetOperation(c13703002.ctop)
	c:RegisterEffect(e2)
	--send to grave
	...
	e3:SetOperation(c13703002.operation)
	c:RegisterEffect(e3)
	local e4=e3:Clone()
	e4:SetCode(EVENT_SPSUMMON_SUCCESS)
	c:RegisterEffect(e4)
end
function c13703002.splimcon(e)
	return not e:GetHandler():IsForbidden()
end
function c13703002.splimit(e,c,sump,sumtype,sumpos,targetp)
	return not c:IsSetCard(0xaf) and bit.band(sumtype,SUMMON_TYPE_PENDULUM)==SUMMON_TYPE_PENDULUM
end

function c13703002.damcon1(e,tp,eg,ep,ev,re,r,rp)
...
function c13703002.ctop(e,tp,eg,ep,ev,re,r,rp)
	...
	local c=e:GetHandler()
		...
		e1:SetLabel(cid)
		e1:SetValue(c13703002.damval)
		e1:SetReset(RESET_CHAIN)
		Duel.RegisterEffect(e1,tp)
	Duel.Destroy(c,REASON_EFFECT)
end
function c13703002.damval(e,re,val,r,rp,rc)
...
function c13703002.operation(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TOGRAVE)
	local g=Duel.SelectMatchingCard(tp,c13703002.tgfilter,tp,LOCATION_DECK,0,1,1,nil)
