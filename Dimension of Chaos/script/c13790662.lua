...
function c13790662.initial_effect(c)
	...
	e1:SetTarget(c13790662.target)
	e1:SetOperation(c13790662.activate)
	c:RegisterEffect(e1)
end
...
function c13790662.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroup(tp,c13790662.cfilter,1,nil) end
	local g=Duel.SelectReleaseGroup(tp,c13790662.cfilter,1,1,nil)
	Duel.Release(g,REASON_COST)
end
function c13790662.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c13790662.activate(e,tp,eg,ep,ev,re,r,rp)
