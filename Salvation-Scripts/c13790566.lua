--Tyrant Burst Dragon
function c13790566.initial_effect(c)
	c:EnableReviveLimit()
	...
	e3:SetTarget(c13790566.eqtg)
	e3:SetOperation(c13790566.eqop)
	c:RegisterEffect(e3)
end
function c13790566.splimit(e,se,sp,st)
	return se:GetHandler():IsCode(13790552)
end
c13790566.material_count=1
c13790566.material={13790568}

function c13790566.eqtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c13790566.eqop(e,tp,eg,ep,ev,re,r,rp)
	...
	e4:SetValue(c13790566.eqlimit)
	e4:SetReset(RESET_EVENT+0x1fe0000)
	e4:SetLabelObject(tc)
	c:RegisterEffect(e4)
end
function c13790566.eqlimit(e,c)
