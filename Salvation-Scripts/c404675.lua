...
function c404675.tokencon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsPlayerCanSpecialSummonMonster(tp,16946850,0,0x4011,800,1000,1,RACE_THUNDER,ATTRIBUTE_LIGHT,POS_FACEUP_DEFENCE,1-tp)
end
function c404675.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsPlayerCanSpecialSummonMonster(tp,16946850,0,0x4011,800,1000,1,RACE_THUNDER,ATTRIBUTE_LIGHT,POS_FACEUP_DEFENCE,1-tp)
		and e:GetHandler():IsCanBeSpecialSummoned(e,0,tp,false,false) end
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,e:GetHandler(),1,0,0)
end
function c404675.spop(e,tp,eg,ep,ev,re,r,rp,c)
	if Duel.GetLocationCount(1-tp,LOCATION_MZONE,tp)<=0
		or not Duel.IsPlayerCanSpecialSummonMonster(tp,16946850,0,0x4011,800,1000,1,RACE_THUNDER,ATTRIBUTE_LIGHT,POS_FACEUP_DEFENCE,1-tp) then return end
