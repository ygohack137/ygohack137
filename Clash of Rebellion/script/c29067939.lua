...
function c29067939.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsPlayerCanSpecialSummonCount(tp,2)
		...
		and Duel.IsExistingMatchingCard(c29067939.xyzfilter,tp,LOCATION_EXTRA,0,1,nil,mg) end
	local exg=Duel.GetMatchingGroup(c29067939.xyzfilter,tp,LOCATION_EXTRA,0,nil,mg)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local sg1=mg:FilterSelect(tp,c29067939.mfilter1,1,1,nil,exg)
	local tc1=sg1:GetFirst()
	local exg2=exg:Filter(c29067939.mfilter2,nil,tc1)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local sg2=mg:FilterSelect(tp,c29067939.mfilter1,1,1,tc1,exg2)
	sg1:Merge(sg2)
...
function c29067939.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.BreakEffect()
	local xyzg=Duel.GetMatchingGroup(c29067939.xyzfilter,tp,LOCATION_EXTRA,0,nil,g)
