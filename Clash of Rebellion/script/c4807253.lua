...
function c4807253.initial_effect(c)	
	...
	e1:SetTarget(c4807253.damtg)
	e1:SetOperation(c4807253.damop)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
	...
	e3:SetCondition(c4807253.condition)
	e3:SetOperation(c4807253.operation)
	c:RegisterEffect(e3)
end
function c4807253.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c4807253.operation(e,tp,eg,ep,ev,re,r,rp)
...
function c4807253.splimit(e,c)
	return not c:IsSetCard(0xc7)
end
function c4807253.refcon(e,re,val,r,rp,rc)
